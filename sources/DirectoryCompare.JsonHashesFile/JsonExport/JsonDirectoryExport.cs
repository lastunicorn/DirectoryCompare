...
namespace DustInTheWind.DirectoryCompare.JsonHashesFile.JsonExport
{
    internal class JsonDirectoryExport
    {
        ...
        public void Open(HDirectory xDirectory)
        {
            DoOpen(xDirectory);
        ...
        protected virtual void DoOpen(HDirectory xDirectory)
        {
        ...
        public JsonDirectoryExport OpenNewDirectory(HDirectory xDirectory)
        {
            CloseFilesNode();
            OpenDirectoriesNode();
