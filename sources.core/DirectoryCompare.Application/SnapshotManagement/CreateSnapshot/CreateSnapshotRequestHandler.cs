...
namespace DustInTheWind.DirectoryCompare.Application.SnapshotManagement.CreateSnapshot
{
    public class CreateSnapshotRequestHandler : RequestHandler<CreateSnapshotRequest, IDiskAnalysisProgress>
    {
        ...
        //private PathAnalysisProgress StartPathAnalysis(Pot pot)
        //{
        //    PathAnalysisProgress pathAnalysisProgress = new PathAnalysisProgress();

        //    Task.Run(() => { RunAnalysis(pot, pathAnalysisProgress); });

        //    return pathAnalysisProgress;
        //}

        //private void RunAnalysis(Pot pot, PathAnalysisProgress pathAnalysisProgress)
        //{
        //    logger.WriteInfo("Scanning path: {0}", pot.Path);
        ...
        //    {
        //        RootPath = pot.Path,
        //        SnapshotWriter = new JsonAnalysisExport(streamWriter),
        //        BlackList = blackListRepository.Get(pot.Name)
        //    };

        //    diskAnalysis.Starting += HandleDiskReaderStarting;
        //    diskAnalysis.ErrorEncountered += HandleDiskReaderErrorEncountered;
        //    diskAnalysis.Progress += (sender, args) => pathAnalysisProgress.ReportProgress(args.Percentage);

        //    diskAnalysis.Run();

        //    pathAnalysisProgress.ReportEnd();
