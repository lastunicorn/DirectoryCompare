...
{
    public class PresentBlackListUseCase : IUseCase<PresentBlackListRequest, DiskPathCollection>
    {
        ...
        public Task<DiskPathCollection> Execute(PresentBlackListRequest request)
        {
